...
function renderWithProps (props = {}) {
  return TestUtils.renderIntoDocument(<Home {...props} />)
}
...
describe('(containers) Home', function () {
  ...
  it('Should include an <h1> with welcome text.', function () {
    ...
    expect(h1).to.exist
    expect(h1.textContent).to.match(/Welcome to the DSwell React Redux Starter Kit/)
  })
